 ...
 */
export const DEMO_MOBILE_E164 = import.meta.env.VITE_DEMO_MOBILE_E164 || "+639000000000";

/** "+639000000000" -> "+63906****188" (keeps enough to recognize the number, masks the rest). */
